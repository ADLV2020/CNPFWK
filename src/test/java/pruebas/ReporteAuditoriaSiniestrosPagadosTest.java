...
public class ReporteAuditoriaSiniestrosPagadosTest {
	...
	public void setUp() throws Exception {
		...
		nombreArchivoEvidencias = "NovaSiniestros - Testing - Evidencias - Reporte de auditoria de Siniestros Pagados - " + Utilities.obtenerFechaActual() + ".docx";
