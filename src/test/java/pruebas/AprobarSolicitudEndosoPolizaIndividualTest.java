...
public class AprobarSolicitudEndosoPolizaIndividualTest {
	...
	public void aprobarSolicitudEndoso(String poliza, String nombretomador, String solicitud, String dnitomador, String nombreasegurado, String dniasegurado, String fechaemision, String fechahasta, String ramo, String comentario) throws InvalidFormatException, IOException, InterruptedException {
		nombreArchivoEvidencias = "PortalProductores - Testing - Evidencias - Aprobar solicitud de Endoso - " + Utilities.obtenerFechaActual() + ".docx";
