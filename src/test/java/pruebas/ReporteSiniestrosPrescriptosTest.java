...
public class ReporteSiniestrosPrescriptosTest {
	...
	public void setUp() throws Exception {
		...
		nombreArchivoEvidencias = "NovaSiniestros - Testing - Evidencias - Reporte de Siniestros Prescriptos - " + Utilities.obtenerFechaActual() + ".docx";
