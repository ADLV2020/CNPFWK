...
public class PolizasModificacionNombreAsegurado {
	...
	public PolizasModificacionNombreAsegurado(WebDriver driver) {
		PageFactory.initElements(new AjaxElementLocatorFactory (driver,20), this);
		wait = new WebDriverWait(driver, Duration.ofSeconds(15));
		this.driver = driver;
	}
	
	public void cargaDatosNombreAsegurado(String apellido, String nombre, String tipoDNI, String dni, String observacion, String prioridad) {
