...
public class ReporteIndicadoresSiniestros {
	
	@FindBy(xpath="//mat-card-title[contains(text(),'Registro de Indicadores de Siniestros')]")
	private WebElement pantallaReporteIndicadoresSiniestros;
	...
	public ReporteIndicadoresSiniestros(WebDriver driver) {
	...
	public boolean pantallaReporteDisponible() {
		return pantallaReporteIndicadoresSiniestros.isDisplayed();
	}
