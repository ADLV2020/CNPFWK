...
public class ReporteProductorRamo {

	@FindBy(xpath="//mat-card-title[contains(text(),' Registro de Siniestros Ingresados por Productor y Ramo ')]")
	private WebElement pantallaReporteProductorRamo;
	...
	public ReporteProductorRamo(WebDriver driver) {
	...
	public boolean pantallaReporteDisponible() {
		return pantallaReporteProductorRamo.isDisplayed();
	}
}
