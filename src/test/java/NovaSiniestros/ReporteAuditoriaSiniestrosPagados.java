...
public class ReporteAuditoriaSiniestrosPagados {
	
	@FindBy(xpath="//mat-card-title[contains(text(),'Registro de Auditoria de Siniestros Pagados')]")
	...
	public ReporteAuditoriaSiniestrosPagados(WebDriver driver) {
