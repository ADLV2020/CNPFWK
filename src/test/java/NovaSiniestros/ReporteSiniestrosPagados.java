...
public class ReporteSiniestrosPagados {
	
	@FindBy(xpath="//mat-card-title[contains(text(),'Registro de Siniestros pagados')]")
	private WebElement pantallaReporteSiniestroPagados;
	...
	public ReporteSiniestrosPagados(WebDriver driver) {
	...
	public boolean pantallaReporteDisponible() {
		return pantallaReporteSiniestroPagados.isDisplayed();
	}
